...
export const PaperImageCard = ({
  ...
  const titleBottom = title ? (sub ? 265 : 210) : 122;
    ...
    <AbsoluteFill style={{fontFamily: 'A2Z Regular, sans-serif'}}>
      ...
      {imageTitle ? (
        <div style={{position: 'absolute', left, width: W, top: top - 56, textAlign: 'center',
                     fontFamily: 'Pretendard Bold, A2Z Medium, sans-serif', fontSize: 38, letterSpacing: '0.01em', color: INK, opacity: o}}>
          {imageTitle}
        </div>
      ) : null}
      ...
      {caption ? (
        <div style={{position: 'absolute', left: 260, width: 1400, top: top + H + 16, textAlign: 'center', fontFamily: 'A2Z Light, sans-serif', fontSize: 30, lineHeight: 1.4, letterSpacing: '0.04em', color: INK_SOFT, opacity: fadeIn(frame, 26), wordBreak: 'keep-all'}}>
          {caption}
        </div>
      ) : null}
