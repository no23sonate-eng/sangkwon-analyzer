  ...
  return (
    <AbsoluteFill style={{fontFamily: 'A2Z Regular, sans-serif'}}>
      ...
      <svg width={1920} height={1080} style={{position: 'absolute', top: 0, left: 0}}>
        {/* 지면 */}
        <line x1={120} y1={GY} x2={1800} y2={GY} stroke={ink} strokeWidth={LW.BODY} opacity={0.4} />
        ...
        {e2 > 0.01 ? (
          <g opacity={0.9}>
            ...
            <line x1={PX} y1={EY} x2={rTop[0]} y2={rTop[1]}
                  stroke={clipped ? RED : ink} strokeWidth={LW.BODY} strokeDasharray="12 9" />
        ...
        <g opacity={t1}>
          <rect x={BX} y={bTop} width={buildingW} height={buildingH}
                fill={dark ? '#39424F' : '#C3C9D2'} stroke={ink} strokeWidth={LW.BODY} />
          <rect x={BX} y={bTop} width={16} height={buildingH} fill={YELLOW} stroke={ink} strokeWidth={LW.THIN} />
        </g>
