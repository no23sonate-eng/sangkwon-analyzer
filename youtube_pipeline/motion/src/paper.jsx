...
//   BAND   96  단과 단 (평면 ↔ 정면)
// ── 2026-09-09 · 전체적으로 위아래가 좁다 ────────────────────────────────
// 카드를 하나씩 손보는 대신 **척도를 올린다.** 좁은 건 늘 아래 세 단이다 —
// 수치와 단위, 라벨과 그 아래 설명, 도형과 라벨. 위 두 단(BLOCK·BAND)은
// 그대로 둔다: 그건 묶음 사이라 이미 충분히 벌어져 있고, 올리면 내용이
// 자막 안전선을 밀어낸다
export const SP = {TIGHT: 12, NEAR: 26, GAP: 44, BLOCK: 64, BAND: 96};
