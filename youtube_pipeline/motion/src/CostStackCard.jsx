  ...
  return (
    <AbsoluteFill style={{fontFamily: 'A2Z Regular, sans-serif'}}>
      ...
      {rows.map((r, i) => (
        <div key={i} style={{position: 'absolute', right: 1920 - (BAR_X - 200),
          ...
          <div style={{marginTop: SP.TIGHT, fontFamily: 'A2Z Medium, sans-serif',
            ...
            {r.prefix ? <span style={{fontSize: 31, color: T.soft, marginRight: 7,
      ...
      <div style={{position: 'absolute', left: BAR_X + BAR_W + SP.BLOCK,
        ...
        <div style={{fontFamily: 'A2Z Light, sans-serif', fontSize: 31, lineHeight: 1,
      ...
      {caption ? (
        <div style={{position: 'absolute', left: 200, width: 1520,
                     ...
                     fontFamily: 'A2Z Light, sans-serif', fontSize: 33,
